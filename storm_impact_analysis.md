...
For easier processing, drop unused columns and format data into a data table
...
12. Estimated 12 month injury count for each event type _(avg # of events x avg injuries per event)_  
13. Estimated 12 month crop damage for each event type _(avg # of events x avg crop damage per event)_  
14. Estimated 12 month property damage for each event type _(avg # of events x avg property damage per event)_
...
These results show that tornadoes, floods, thunderstorms, and excessive heat are the event categories most likely to cause the greatest human or economic harm in a given year.
